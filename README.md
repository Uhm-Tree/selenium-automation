...
`config.py`의 URL을 테스트할 웹 환경에 맞게 설정합니다.
...
Timeout이 발생하면서 전체 자동화가 중단되었습니다.

해결

- `TimeoutException`을 처리하고 드롭다운 메뉴를 다시 탐색하도록 로직을 개선했습니다.
이를 통해 API가 없는 프로젝트는 자동으로 건너뛰고,
다음 프로젝트를 계속 탐색할 수 있도록 구현했습니다.
